...
8. **[Replay](replay.md)** - replay recorded follower arm motion on the physical hardware to verify a recording.
9. **[Visualize](visualization.md)** - inspect converted recordings interactively in Rerun.
